...
Run:
```
sudo apt install cmake g++ git make python3 libboost-all-dev
python3 ./build.py
python3 ./tests/tester.py
python3 ./tests/analyzer.py
```

The main results will be in `./tests/analysis/FD-IPC-opt-strips.csv`.

We implemented our algorithm using a version of the Fast Downward with some modifications.
