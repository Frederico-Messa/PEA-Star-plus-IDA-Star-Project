...
public:
    ...
    static long unsigned int time_limit;
    static long unsigned int open_limit;
    static std::optional<int> second_phase_lower_bound;
    static bool using_partial_expansion;
};
